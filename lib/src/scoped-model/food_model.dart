...
class FoodModel extends Model {
  ...
  Future<bool> addFood(Food food) async {
    ...
    try {
      ...
      final http.Response response = await http.post(
          "https://food-delivery-app-ec0a1-default-rtdb.firebaseio.com/foods.json",
  ...
  Future<bool> fetchFoods() async {
    ...
    try {
      final http.Response response = await http
          .get("https://food-delivery-app-ec0a1-default-rtdb.firebaseio.com/foods.json");
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async {
    ...
    try {
      await http.put(
          "https://food-delivery-app-ec0a1-default-rtdb.firebaseio.com/foods/${foodId}.json",
          body: json.encode(foodData));
