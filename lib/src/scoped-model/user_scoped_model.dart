import 'package:flutter_app/src/enums/auth_mode.dart';
import 'package:flutter_app/src/models/user_info_model.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://food-delivery-app-ec0a1-default-rtdb.firebaseio.com/users.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://food-delivery-app-ec0a1-default-rtdb.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBHve4ch-s2th8hLuKTN5abvUYnTU8fg1U",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBHve4ch-s2th8hLuKTN5abvUYnTU8fg1U",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
